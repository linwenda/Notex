...
{
    public class EditNoteCommandHandler : ICommandHandler<EditNoteCommand, MarchNoteResponse>
    {
        private readonly IUserContext _userContext;
        private readonly INoteRepository _noteRepository;

        public EditNoteCommandHandler(IUserContext userContext, INoteRepository noteRepository)
        {
